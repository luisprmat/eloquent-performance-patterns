...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        User::find(7)->update(['name' => 'Luis Parrado']);

        $this->getBooks()->map(fn (array $book) => Book::create($book));
    }
    ...
    protected function getBooks()
    {
        return collect([
            ...
            ['name' => 'Design Patterns: Elements of Reusable Object-Oriented Software', 'author' => 'Erich Gamma', 'user_id' => 7],
            ...
            ['name' => 'Manage Your Project Portfolio', 'author' => 'Johanna Rothman', 'user_id' => 7],
